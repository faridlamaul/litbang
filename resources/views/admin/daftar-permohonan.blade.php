                        ...
                        <tbody>
                            <tr class="bg-indigo-50">
                                ...
                                <td class="py-2 border border-gray-200 text-center">
                                    <a href="{{ url('detail-permohonan') }}">
                                        <button class="text-white focus:outline-none focus:ring-1 focus:ring-offset-2 focus:ring-purple-700 bg-purple-700 transition duration-150 ease-in-out hover:bg-purple-600 rounded-lg border-purple-700 px-2 py-1 mx-1">
                                            Detail
                                        </button>
                                    </a>
                                    <button class="text-white focus:outline-none focus:ring-1 focus:ring-offset-2 focus:ring-red-700 bg-red-700 transition duration-150 ease-in-out hover:bg-red-600 rounded-lg border-red-700 px-2 py-1 " data-bs-toggle="modal" data-bs-target="#exampleModalCenter">
                                        Hapus
                                    </button>
                                </td>
                            ...
                            <tr class="bg-indigo-100">
                                ...
                                <td class="py-2 border border-gray-200 text-center">
                                    ...
                                    <button class="text-white focus:outline-none focus:ring-1 focus:ring-offset-2 focus:ring-red-700 bg-red-700 transition duration-150 ease-in-out hover:bg-red-600 rounded-lg border-red-700 px-2 py-1">
                                        Hapus
                                    </button>
                                </td>
                            </tr>
