        ...
        <div class="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8 bg-slate-100 rounded-md">
            <div class="">
                ...
                <div>
                    <div class=" px-7 py-3">
                        <div
                            class="border-none shadow-lg relative flex flex-col w-full pointer-events-auto bg-white bg-clip-padding rounded-md outline-none text-current mb-10">
                            <div
                                class="flex flex-shrink-0 items-center justify-between p-4 border-b border-gray-200 rounded-md">
