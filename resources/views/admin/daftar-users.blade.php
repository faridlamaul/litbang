                        ...
                        <tbody>
                            <tr class="bg-indigo-50">
                                ...
                                <td class="py-2 border border-gray-200 text-center">
                                    ...
                                    <button class="text-white focus:outline-none focus:ring-1 focus:ring-offset-2 focus:ring-red-700 bg-red-700 transition duration-150 ease-in-out hover:bg-red-600 rounded-lg border-red-700 px-3 py-1" data-bs-toggle="modal" data-bs-target="#exampleModalCenter">
                                        Hapus
                                    </button>
                                    {{-- </a> --}}
                                </td>
