...
<div class="bg-gray-100">
    <div class="container mx-auto flex flex-col items-center py-12 sm:py-24">
        <div class="w-11/12 sm:w-2/3 lg:flex justify-center items-center flex-col  mb-5 sm:mb-10">
            ...
            <p class="mt-5 sm:mt-10 lg:w-10/12 text-gray-400 font-normal text-center text-sm sm:text-lg">Apikasi layanan litbang yang berguna untuk mempermudah pengajuan surat perizinan magang, kerja praktek, KKN, dan penelitian pada Pemerintah Kabupaten Gresik.</p>

        </div>
        <div class="flex justify-center items-center">
            <a href="{{ url('/dashboard') }}">
                <button class="focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 bg-indigo-700 transition duration-150 ease-in-out hover:bg-indigo-600 lg:text-xl lg:font-bold  rounded text-white px-4 sm:px-10 border border-indigo-700 py-2 sm:py-4 text-sm">Buat permohonan surat</button>
            </a>
            <a href="#works">
                <button class="ml-4 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 bg-transparent transition duration-150 ease-in-out hover:border-indigo-600 lg:text-xl lg:font-bold  hover:text-indigo-600 rounded border border-indigo-700 text-indigo-700 px-4 sm:px-10 py-2 sm:py-4 text-sm">Cara Kerja</button>
            </a>
        </div>
    </div>
    <section id="works">
        <div class="max-w-8xl mx-auto container bg-white dark:bg-gray-900 pt-16 mt- mb-4">
            <div role="contentinfo" class="flex items-center flex-col px-4">
                ...
                <h1 tabindex="0" class="focus:outline-none text-4xl lg:text-4xl font-extrabold text-center leading-10 text-gray-800 dark:text-white lg:w-5/12 md:w-9/12 pt-4">Cara kerja web aplikasi Litbang</h1>
            </div>
