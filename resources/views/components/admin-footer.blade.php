 <div>
     <footer id="footer" class="relative z-50 dark:bg-gray-900">
                 ...
                 <div class="lg:flex">
                     <div class="w-full lg:w-1/2 mb-16 lg:mb-0 flex">
                         <div class="w-full lg:w-1/2 px-6">
                             <ul>
                                 <li><a class="focus:outline-none focus:underline  text-xs lg:text-sm leading-none hover:text-brand dark:hover:text-brand text-gray-800 dark:text-gray-50" href="javascript:void(0)">Buat Permohonan Surat</a></li>
                                 ...
                                 <li class="mt-6"><a class="focus:outline-none focus:underline text-xs lg:text-sm leading-none hover:text-brand dark:hover:text-brand text-gray-800 dark:text-gray-50" href="javascript:void(0)">Kontak admin</a></li>
                             </ul>
                         </div>
                         <div class="w-full lg:w-1/2 px-6">
                             <ul>
         ...
         <div class="py-10 flex flex-col justify-center items-center">
             ...
             <p tabindex="0" class="focus:outline-none mt-6 text-xs lg:text-sm leading-none text-gray-900 dark:text-gray-50">2022 Litbang-App. All Rights Reserved.</p>
         </div>
     </footer>
 </div>
