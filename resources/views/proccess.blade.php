...
@section('content')
    <div class="container mx-auto h-screen">
        <div class="min-h-full flex flex-col items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
            <h1 class="mt-6 text-center text-3xl font-extrabold text-gray-900">Terima Kasih Telah Menggunakan Layanan Kami
            </h1>
            <h1 class="mt-6 mb-10 text-center text-2xl font-extrabold text-gray-900">Surat Anda Sedang di Proses</h1>
            <a href="{{ url('/user/proccess') }}" data-bs-toggle="modal" data-bs-target="#beriPenilaian">
                <button
                    class="focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 bg-indigo-700 transition duration-150 ease-in-out hover:bg-indigo-600 lg:text-xl lg:font-bold  rounded text-white px-4 sm:px-10 border border-indigo-700 py-2 sm:py-4 text-sm">Beri
                    Penilaian</button>
            </a>
        </div>
    </div>
    ...
    <div class="modal fade fixed top-0 left-0 hidden w-full h-full outline-none overflow-x-hidden overflow-y-auto"
        id="beriPenilaian" tabindex="-1" aria-labelledby="beriPenilaianTitle" aria-modal="true" role="dialog">
