...
<div class="container mx-auto h-screen">
    <div class="min-h-full flex flex-col items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        ...
        <a href="{{ url('/user/proccess') }}" data-bs-toggle="modal" data-bs-target="#beriPenilaian">
            <button class="focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 bg-indigo-700 transition duration-150 ease-in-out hover:bg-indigo-600 lg:text-xl lg:font-bold  rounded text-white px-4 sm:px-10 border border-indigo-700 py-2 sm:py-4 text-sm">Beri
                Penilaian</button>
        </a>
    </div>
</div>
